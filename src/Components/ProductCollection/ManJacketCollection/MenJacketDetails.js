...
const MenJacketDetails = (props) => {
  const { category, name, price, imagesUrl } = props.JakcetDetailInfo;
          ...
          <div className = "col-sm-8 detail-content">
            <div div className='ditailsContent'>
              ...
              <div className='qbtn-div' style={{marginBottom: '20px'}}>
                ...
                <button onClick={() => dispatch(addToCart(props.JakcetDetailInfo))}><span><FontAwesomeIcon icon={faCartPlus} /></span> Add To Cart</button>
...
export default MenJacketDetails
