...
import QuickView from './../SweaterCollection/QuickView/QuickView';
...
const Hoodie = (props) => {
  ...
  useEffect(() => {
    fetch(`https://protected-crag-98903.herokuapp.com/hoodie/${_id}`)
      .then((res) => res.json())
    ...
    <div>
      <div className="hoodieDiv">
        ...
        <div className='interactionDiv'>
          ...
          <div className='interaction-container d-flex' onClick={() => dispatch(addToCart(props.hoodie))}><small>Add to cart</small> <div className='interactionIcon-div'><span className='interactionIcon'><FontAwesomeIcon icon={faCartPlus} /></span></div></div>
