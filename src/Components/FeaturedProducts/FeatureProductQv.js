...
const FeatureProductQv = (props) => {
  const { category, name, price, imagesUrl, description1, description2 } = props.jacketDetailInfo;
  
  console.log(props.jacketDetailInfo)
          ...
          <div className = "col-sm-8 detail-content">
            <div div className='ditailsContent'>
              ...
              <div className='qbtn-div' style={{marginBottom: '20px'}}>
                ...
                <button><span><FontAwesomeIcon icon={faCartPlus} /></span> Add To Cart</button>
...
export default FeatureProductQv
